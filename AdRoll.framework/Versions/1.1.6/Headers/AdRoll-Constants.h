...
/*! Gender constants */
typedef NS_ENUM(NSInteger, ARGender) {
    /*! Fallback case when the gender of the user is known but it is still valuable to record it in. */
    ARGenderUnknown=0,
    /*! Male gender */
    ARGenderMale=1,
    /*! Female gender */
    ARGenderFemale=2,
    /*! Other gender, different than unknown. */
    ARGenderOther=3
};
