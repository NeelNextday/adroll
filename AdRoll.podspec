Pod::Spec.new do |s|
  ...
  s.source              = { :git => "git@github.com:AdRoll/adroll-ios.git", :tag => "1.1.4" }
  s.social_media_url    = 'https://twitter.com/AdRoll'

  s.platform            = :ios, '6.0'
  s.requires_arc        = true

  s.source_files        = 'AdRoll.framework/Versions/1.1.4/Headers/{AdRoll,AdRoll+Advanced,AdRoll-Constants}.h'
